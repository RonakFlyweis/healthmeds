...
import '../productaddtocard/productaddtocart.dart';
...
class _GetProductListState extends State<GetProductList> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: ApiProvider.getReqBodyData(endpoint: getAllProducts),
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        if (snapshot.connectionState == ConnectionState.done &&
            snapshot.hasData) {
          //print('printed data' + snapshot.data.toString());
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      PageTransition(
                          ...
                          child: Product(productDetails: element)));
                  // Navigator.push(
                  //     context,
                  //     PageTransition(
                  //         type: PageTransitionType.rightToLeft,
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Hero(
                            tag: '${element['productPictures'][0]['filename']}',
                            child: Container(
                              width: 70.0,
                              height: 70.0,
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: NetworkImage(
                                      imagebaseurl +
                                          element['productPictures'][0]['filename']
                                              .toString()),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                    '${element['title']} ${element['pack_size']}',
